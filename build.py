...
DATA = [
 ...
 # ---------------- BEDROOM & COMFORT ----------------
 dict(id="blankets", cat="bedroom", name="Guest Throw Blankets", tag="Plain · dark · $22–30",
   note="Reset to the brief: plain woven cotton, dark stain-friendly colors, $20–30, you embroider the corner seal in-house. The VHC waffle family gives one consistent blanket program across three dark colorways. Charcoal watch: Superior's basketweave charcoal ($29.80) is temporarily out of stock direct (~$31.38 at Bed Bath & Beyond) — VHC's Dark Grey is the in-stock stand-in. Verified fails so you don't chase them: Great Bay Home dark colorways don't come in 50×60 ($45+ otherwise), IKEA VÅRELD discontinued, Utopia/Glamburg promo-grade. Embroidery tip: waffle wants medium cutaway stabilizer and an open fill; the basketweave takes the crispest small text.",
   options=[
     opt("recommended","VHC Waffle Weave Cotton Throw — Dark Gray, 50×60","VHC Brands · at Allyson's Place","https://allysonsplace.com/products/vhc-brands-waffle-weave-dark-gray-throw-50x60-cotton-blanket-for-boho-farmhouse-bedroom-living-room-decor-couch-sofa-bed",
         "$21.95","/ ea","qty 1 retail","min 1","100% cotton flat-woven waffle (no nap) · pre-washed · machine washable · solid dark grey, reads charcoal","In-house corner embroidery (cream seal pops on the dark ground)",
         "The exact spec at the cheapest verified price — plain, dark, woven, pre-washed so it embroiders stable and survives Airbnb laundry. $100+ under the heritage throws.","assets/img/blanket-vhcgray.jpg"),
     opt("alt","VHC Waffle Weave Cotton Throw — Olive Green, 50×60","VHC Brands · at Allyson's Place","https://allysonsplace.com/products/vhc-brands-waffle-weave-olive-green-throw-blanket-50x60-boho-farmhouse-cotton-decor-for-bed-couch-sofa",
         "$21.95","/ ea","qty 1 retail","min 1","Same 100% cotton woven waffle · pre-washed · solid olive/forest","In-house corner embroidery — wheat/cream seal on olive",
         "The forest slot of the palette at the same $21.95 — run a different dark colorway per room on one consistent blanket program.","assets/img/blanket-vhcolive.jpg"),
     opt("alt","VHC Waffle Weave Throw — Navy (maker-direct)","VHC Brands (vhcbrands.com)","https://vhcbrands.com/products/waffle-weave-blanket",
         "$25.95","/ ea","qty 1 · Grey / Navy / Olive all in stock direct","min 1","Identical waffle family from the manufacturer · Navy only sold here","In-house corner embroidery",
         "Supply redundancy for the same SKU family plus the navy colorway — worth the $4 premium when Allyson's sells out.","assets/img/blanket-vhcnavy.jpg",
         badge="Navy · maker-direct"),
     opt("premium","Superior Basketweave Thermal Throw — Navy, 50×60","Superior (manufacturer direct)","https://www.superiorbrand.com/products/basket-weave-all-season-100-cotton-thermal-woven-blanket",
         "$29.80","/ ea","qty 1 · charcoal on restock watch","min 1","100% cotton woven basketweave thermal · self-binding edges, mitered corners · OEKO-TEX 100","The crispest embroidery surface here — flat tight weave holds small text",
         "The dressiest drape of the set with hotel-style mitered corners — and the tight flat weave takes the finest seal detail of any of them.","assets/img/blanket-superiornavy.jpg",
         badge="Crispest embroidery"),
   ]),
 dict(id="sewing", cat="bedroom", name="Disposable Sewing Kit", tag="Paper / fabric — no plastic",
   note="Brandability pass, photos actually inspected: the previous matchbook rec (Hotel Supplies USA, $0.60) turned out to have a pre-printed leaf cover with a decorative button and bow — no clean field for the seal, so it's retired. HospitalityEmporium's $0.18 box carries the supplier's own printed logo — note only. Also verified: PackM prints custom pillow boxes at MOQ 50 but ~$3.20/kit; every promo-channel sewing kit checked except ImprintItems is a plastic case; World Amenities kraft grooming sachet ($0.54 at 100, sewing kit inside, custom runs offered) remains a solid combo play. Honest flag on inserts: the thread-card refills are polybagged inside — outer presentation stays 100% paper.",
   options=[
     opt("recommended","DIY: Blank Kraft Pillow Box + Thread-Card Insert","ClearBags (boxes) + MTQY inserts (Amazon)","https://www.clearbags.com/2-1-2-x-7-8-x-4-kraft-pillow-boxes-25-pieces-kpb100.html",
         "≈ $0.33","/ kit","boxes $5.75/25 + inserts $9.99/100 ≈ $33 per 100 kits","min 100","Plain natural kraft pillow box, 2.5×4″ face (fits the 2″ seal stamp exactly) · insert: 6 threads, needle, 2 buttons, gold safety pin","Truly BLANK canvas — stamp, UVDTF, or laser-scorch the kraft",
         "The only route verified to give a genuinely unprinted kraft surface at 100 qty — image-inspected, zero pre-printed art. Ten minutes of assembly per case, and it matches the ranch look perfectly.","assets/img/sewing-pillowbox.jpg",
         badge="Blank kraft · $0.33"),
     opt("alt","ECO Sciences Raw-Kraft Box Mending Kit","Branded Amenities (CA) / CustomAmenities (US)","https://brandedamenities.com/products/hotel-toiletries-sewing-kit-eco-sciences",
         "≈ $0.26","/ kit","≈ CAD $35 / 100 · US sister site $28/100 (restock watch)","min 100","Raw brown kraft upright carton, soy ink · 6-color thread card, needle, pins, 2 buttons","Four uninterrupted kraft panels for stamp/UVDTF",
         "The pre-assembled version of the same idea — minimal print, big kraft canvas. Sole tradeoff: ships from Canada until the US site restocks.","assets/img/sewing-kraftbox.jpg",
         badge="Raw kraft canvas"),
     opt("alt","Custom-Printed Paper Matchbook Kit (#4090-02)","ImprintItems (Admatch)","https://www.imprintitems.com/product/9755292",
         "quote","/ kit","$500 order min + $55/color setup · 20-day production","min ~250","2⅛×1⅞″ paper matchbook, white stock · offset print across the ENTIRE cover · threads, needle, buttons inside","Supplier prints the seal — a 1-color B&W job is their cheapest tier",
         "The only verified custom-printed PAPER matchbook in the promo channel (everything else is plastic) — the true hotel-matchbook play with your seal professionally printed.","assets/img/sewing-imprint.jpg",
         badge="Seal printed for you"),
     opt("alt","DIY: Kraft Slide-Drawer Matchbox + Insert","Kraft Packaging Store + MTQY inserts","https://www.kraftpackagingstore.com/product-page/small-size-brown-kraft-paper-slide-drawer-box",
         "≈ $0.92","/ kit","boxes $82.33/100 (50-lot min) + $0.10 insert","min 50","True matchbox slide-drawer format · plain unprinted kraft, 28 sizes · 7–12 day overseas ship","Blank canvas — the most 'vintage hotel matchbox' format",
         "If you want the matchbox aesthetic specifically (drawer slide, not pillow box) — blank kraft at a 50-box minimum, just plan for the shipping window.","assets/img/sewing-drawerbox.jpg",
         badge="Matchbox format"),
 ...
 dict(id="cornhole", cat="outdoor", name="Cornhole Boards (blank for DTF)", tag="Birch blanks + black",
   note="Black options added per request — white seal on black pops, and black hides scuffs and weather. Verified while hunting black: GoSports' solid-black PRO set ($129.99) is real but SOLD OUT everywhere; Slick Woody's has zero solid black (their 'Lava Rock' is red-brown wood grain); AJJ's solid-color pages all 404 (call 1-888-504-7112); Dirty Bags blanks come only in raw birch; Franklin's $74.98 near-black set is 3×2 MDF — porch-roof duty only. DTF-on-paint tip: press the transfer, then seal with outdoor spar/poly clear; for UVDTF, clear-coat first, then apply.",
   options=[
     opt("recommended","Solid Black Cornhole Boards (bags included)","All American Tailgate (USA)","https://www.allamericantailgate.com/solid-black-cornhole-board/",
         "$174.00","/ set","sale (MSRP $217.50) · qty 1 · in stock","min 1","Regulation 2×4 · painted jet-black · real wood frames (upgrades to ACL Pro / 3/4″ builds) · corn-filled bags included","In-house white-seal DTF on the black top, then clear-coat",
         "The only verified in-stock true solid-black wood set anywhere — regulation, real wood, cheapest full-size black, and the white ranch seal will pop hard on it.","assets/img/cornhole-black.png",
         badge="Solid black"),
     opt("alt","Custom Set — Black + Seal, Factory-Sealed (UV print)","CornholeAce (USA)","https://cornholeace.com/products/custom-cornhole-board-set-standard",
         "$249.99","/ set","Standard · Pro (3/4″ throughout) $349.99 · ships 1–3 days","min 1","Regulation 2×4 · upload black field + white seal, they UV-print and clear-coat it · bags separate","Supplier UV-print, sealed under their clear — zero in-house work",
         "Same tournament builder as the birch rec: they print the black + seal for you under UV clear that won't peel — the most weatherproof branding path of all.","assets/img/cornhole-aceblack.jpg",
         badge="Black + seal, sealed"),
     opt("alt","Plain Unfinished Set — 3/4″ Baltic Birch (No Poly)","CornholeAce (USA)","https://cornholeace.com/products/plain-unfinished-cornhole-board-set-professional-no-poly",
         ...
         "The premium raw-birch blank — the smoothest DTF base, tournament-grade, if you want the natural-wood look instead of black.","assets/img/cornhole-rec.jpg"),
