...
DATA = [
 ...
 dict(id="sewing", cat="bedroom", name="Disposable Sewing Kit", tag="Paper packaging",
   note="All non-plastic paper styles (no clamshell cases). More eco-kraft: World Amenities Grooming Kraft Sachet ($0.35/ea, min 300) and Maples 'Eden' kraft box both print your logo (overseas / higher MOQ). For a boutique touch: linen 'hussif' fabric-roll kits and Sashiko paper-box mending kits on Etsy (premium, small batches).",
   options=[
