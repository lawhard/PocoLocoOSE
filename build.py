...
DATA = [
 ...
 dict(id="opener", cat="bar", name="Bottle Opener", tag="Brass & walnut",
   note="Upgraded with a real premium tier: solid patina-ing brass, laser-marked in-house. Restock watch: Standard Pattern hex opener ($32, machined in Indiana since 1937, sold out at Portland Trading Co). Fort Standard's brass openers couldn't be verified live (maker site down), so they're excluded rather than guessed.",
   options=[
     ...
     opt("alt","Leather-Wrapped Paddle Opener","The Local Branch (USA made)","https://thelocalbranch.co/products/bottle-opener",
         "$28.00","/ ea","qty 1","min 1","~7″ antiqued-brass paddle · removable genuine leather sleeve · hanging loop","Two canvases: laser the paddle AND stamp the slide-off leather sleeve",
         "Antiqued brass + leather is the most rustic-Texas option here, and the removable sleeve is tailor-made for your stamps.","assets/img/opener-localbranch.jpg"),
     opt("value","Solid Brass Bottle Opener (unlacquered)","Civil Alchemy (St. Louis)","https://civilalchemy.com/products/brass-bottle-opener",
         "$24.00","/ ea","qty 1","min 1","Solid unlacquered brass · 6×1.5″ · patinas naturally or polishes back","In-house fiber laser on the brass face",
         "The cheapest true solid-brass opener verified in stock — the one-per-cabin play instead of a single showpiece.","assets/img/opener-civilalchemy.jpg"),
 ...
 dict(id="coffeecups", cat="bar", name="Branded Coffee Cups", tag="Low MOQ · kraft",
   note="Re-sourced around low volume. The lead is the boutique-café trick: premium blank kraft cups + a $29 self-inking seal stamp — $61 starts you with 100 cups+black lids, then ~$0.32/serving forever, and the stamp doubles as a whole-property branding tool (bags, sleeves, sewing kits). Test 25 cups for $5.29 first. Also verified: Zazzle proofs your art from just 8 cups (~$1.80); UNICUP does double-wall kraft full-wrap at 100 (configurator pricing). Retired: Your Brand Cafe (real MOQ now 1,000).",
   options=[
     opt("recommended","Blank Double-Wall Kraft Cups + Custom Seal Stamp","WebstaurantStore + Simply Stamps","https://www.webstaurantstore.com/choice-12-oz-double-wall-ripple-kraft-paper-hot-cup-and-black-lid-pack/50012RIPKR100.html",
         "≈ $0.32","/ serving","first 100 cups + lids + stamp ≈ $61 · stamp $29 one-time","min 25","12oz double-wall ripple kraft, PE-lined, no sleeve needed · matching black lids · 2″ round self-inking logo stamp, 7 ink colors","In-house: hand-stamp the seal on the flat kraft band",
         "The boutique-café trick — black-lid-on-kraft with a hand-stamped seal reads artisan, costs a third of printed cups, and the stamp brands everything else on the property too.","assets/img/cup-kraftblank.jpg",
         badge="The stamp trick"),
     opt("alt","12oz FSC Full-Color Printed Cup + PLA Lid","DiscountMugs","https://www.discountmugs.com/product/ascpp6857-12-oz-fsc-full-color-paper-cup-with-lid/",
         "$2.16","/ cup","+$49 setup · ≈$3.14/cup effective at 50","min 50","FSC paper, made in USA · biodegradable PLA lid included · near-full-wrap 10×3.75″ print · black or white","Supplier full-color print",
         "The lowest verified full-color print minimum in the US (50 cups) — the zero-labor premium look when you outgrow the stamp.","assets/img/cup-discountmugs.jpg",
         badge="Full print at 50"),
     opt("alt","Printed Kraft Coffee Sleeves (over blank cups)","Under A Buck + WebstaurantStore","https://underabuck.com/products/printed-coffee-sleeve-brown-kraft-coffee-clutch-ub087a6501",
         "≈ $0.88","/ finished cup","sleeves $0.67/100, no setup, free ship · + $0.21 blank cup","min 100","Recycled kraft clutch, fits 10–16oz · 1-color imprint 1.75×3.5″ · 5–10 day turnaround","Supplier prints the sleeve; cups stay blank",
         "Professionally printed branding at exactly 100 units with no setup fee — and you can swap the art seasonally without re-buying cups.","assets/img/cup-sleeve.webp"),
     opt("value","12oz Recyclable Cup — 1-Color Print","The Cup Store","https://thecupstore.com/products/12-oz-custom-printed-recyclable-paper-cup",
         "≈ $1.06","/ cup","$106.30 / 100","min 100","Recyclable single-wall paper · 1-color logo print · lids available","Supplier-printed (1-color seal)",
         "The cheapest verified fully-printed run — $106 gets 100 cups with the seal on them, done.","assets/img/cup-cupstore.jpg"),
   ]),
 # ---------------- BEDROOM & COMFORT ----------------
 ...
 dict(id="pens", cat="welcome", name="Pens with Heft & Character", tag="Solid brass · qty 1",
   ...
   note="Re-sourced to boutique grade: all four mains are RAW SOLID BRASS, qty 1, and your fiber laser marks bare brass dark and crisp with no coating step. Brass ages from bright gold to a tobacco patina with guest handling — on-brand for the ranch (a jeweler's cloth restores shine). The old promo-supplier picks (min 100) are retired. Runner-ups verified: Kaweco Liliput brass $82, ystudio Classic Revolve $100 (+$20 engraving), Inventery Bolt Action $124. Craighill and Fisher both run wholesale programs if you standardize.",
   options=[
     opt("recommended","Fisher Space Pen Bullet — Raw Brass (#400RAW)","Goldspot Pens (also spacepen.com)","https://goldspot.com/products/fisher-bullet-space-400raw-classic-raw-brass-bullet-space-ballpoint-pen",
         ...
         "A 1948 American design icon (it's in MoMA) that reads heritage-ranch, not corporate. Real heft, patinas like a saddle fitting, and cheap enough that the stolen pen becomes the souvenir.","assets/img/pen-fisherbullet.jpg"),
     opt("value","Fisher Cap-O-Matic — Raw Brass","Goldspot Pens","https://goldspot.com/products/fisher-space-pen-cap-o-matic-ballpoint-pen-raw-brass",
         "$25.50","/ pen","retail, sold individually","min 1","Raw brass body · full size (~5.1″) · one-hand click · any-angle pressurized refill","In-house laser — straight clip-free barrel",
         "The workhorse: full-size, clickable, solid brass at $25 — the every-nightstand pen while the hero pens sit at the writing desk.","assets/img/pen-capomatic.jpg",
         badge="Nightstand fleet"),
     opt("alt","Brass Ballpoint Pen (bullet-pencil style)","TRAVELER'S COMPANY USA (Midori)","https://shop.travelerscompanyusa.com/products/trc-brass-ball-point-pen-solid-brass",
         "$33.00","/ pen","retail · $2 refills","min 1","Solid unlacquered brass, made in Tokyo · 4″ pocket format, extends to full size · lanyard ring","In-house laser · tether to a leather cord",
         "Craft-workshop object with a rancher's shirt-pocket silhouette; the ring lets you tie it to the guestbook on a leather cord.","assets/img/pen-trc.jpg"),
     opt("premium","Kepler Pen — Machined Brass","Craighill (Brooklyn · milled in Wisconsin)","https://craighill.co/products/kepler-pen",
         ...
         "The writing-desk pen you'd find at an Auberge property — sculptural, weighty, quietly luxurious. Craighill's corporate program makes it the most OS&E-ready maker here.","assets/img/pen-kepler.jpg",
         badge="Writing-desk hero"),
     opt("alt","BRASS Sport Ballpoint","Kaweco · at Vanness Pens","https://vanness1938.com/products/kaweco-brass-sport-ballpoint",
         "$88.00","/ pen","retail · ships in Kaweco gift tin","min 1","Solid CNC brass · iconic octagonal Sport, ~4.2″ · D1 refill · 1911 German heritage","In-house laser on a flat facet (best surface here)",
         "The facet classic — eight true flats made for a laser. US street price has crept to $88, so cast it as a hero desk pen, not the fleet.","assets/img/pen-kaweco.jpg"),
   ]),
